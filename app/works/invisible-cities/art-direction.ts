...
const directions: Record<string, RawDirection> = {
  ...
  eudoxia: [
    'orbit',
    'THE CARPET KNOWS THE TRUE FORM',
    '地毯知道真实形态',
    '#23172d',
    '#edcf87',
    '#d13370',
  ...
  thekla: [
    'machine',
    'BUILDING SO DESTRUCTION CANNOT BEGIN',
    '不停建造，因此不被毁灭',
    '#132026',
    '#d7d2bd',
    '#ff5d32',
  ...
  procopia: [
    'crowd',
    'THE LANDSCAPE FILLS WITH FACES',
    '风景被人脸填满',
    '#21301e',
    '#dce0be',
    '#e8572d',
  ...
  cecilia: [
    'maze',
    'THE CITY SWALLOWS THE COUNTRYSIDE',
    '城市吞没乡野',
    '#28271d',
    '#d9d7bd',
    '#e55232',
  ...
  berenice: [
    'machine',
    'JUSTICE INSIDE INJUSTICE INSIDE JUSTICE',
    '正义藏在不义之中',
    '#201b1b',
    '#e0d5ca',
    '#d62e2e',
